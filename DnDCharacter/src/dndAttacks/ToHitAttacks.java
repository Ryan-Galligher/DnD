 ...
 * @author Ryan
 */
public class ToHitAttacks     //This holds not only multiple attacks, but also a single pairing of to hit dice and damage dice
{
    ...
    public ToHitAttacks(Dice[] toHitCombo, Dice[] toHurtCombo, String[] descriptions)    //The items put in the arrays here are the attacks that will be done sequentially, so all within the Dice[] will be done
    {
