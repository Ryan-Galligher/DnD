 ...
 * @author Ryan
 */
public class BrownBear extends Minions{
    public BrownBear()
    {
        super.hp=2;
        super.ac=2;
    ...
    public BrownBear(int wizlv, int proficiency, int acBoost)
    {
    ...
    public void setUp(int wizlv, int proficiency, int acBoost)
    {
        ...
        {                                   //the different Attacks in Attack[] are the different combos that the creature could attack with on their turn, while diff attacks in Attack() will all be done consecutively
            new Attacks(
                new Dice[]{
                    new Dice(20,1,5),new Dice(20,1,5)},
                new Dice[]{
                    new Dice(8,1,4),new Dice(6,2,4)},
                new String[]{name + " Bite, Range 5 feet Piercing", name+" Claws, 5ft slashing"}),
