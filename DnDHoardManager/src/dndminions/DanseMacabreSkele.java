 ...
 * @author Ryan
 */
public class DanseMacabreSkele extends Minions {
    
    public DanseMacabreSkele()
    {
        super.hp=2;
        super.ac=2;
        super.name="DMSkele";
    ...
    public DanseMacabreSkele(int wizlv, int proficiency, int acBoost)
    {
        ...
        {                                   //the different Attacks in Attack[] are the different combos that the creature could attack with on their turn, while diff attacks in Attack() will all be done consecutively
            new Attacks(
                new Dice[]{
                    new Dice(20,1,4+5)},
                new Dice[]{
                    new Dice(6,1,2+proficiency+5)},
                new String[]{name + " Short Bow, Range 80-320 feet"}),
            new Attacks(
                new Dice[]{
                    new Dice(20,1,4+5)},
                new Dice[]{
                    new Dice(6,1,2+proficiency+5)},
                new String[]{name + " Short Sword, range 5ft"}),
