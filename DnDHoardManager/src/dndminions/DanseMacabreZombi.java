 ...
 * @author Ryan
 */
public class DanseMacabreZombi extends Minions {
    
     public DanseMacabreZombi()
    {
        super.hp=2;
        super.ac=2;
        super.name="DMZombi";
    ...
    public DanseMacabreZombi(int wizlv, int proficiency, int acBoost)
    {
