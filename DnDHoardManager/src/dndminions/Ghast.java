 ...
 * @author Ryan
 */
public class Ghast extends Minions{
    public Ghast()
    {
        super.hp=2;
        super.ac=2;
    ...
    public Ghast(int wizlv, int proficiency, int acBoost)
    {
        ...
        {                                   //the different Attacks in Attack[] are the different combos that the creature could attack with on their turn, while diff attacks in Attack() will all be done consecutively
            new Attacks(
                new Dice[]{
                    new Dice(20,1,3)},
                new Dice[]{
                    new Dice(8,2,3+proficiency)},
                new String[]{name + " Bite, Range 5ft piercing"}),
            new Attacks(
                new Dice[]{
                    new Dice(20,1,5)},
                new Dice[]{
                    new Dice(6,2,3+proficiency)},
                new String[]{name + " Claws, range 5ft slashing, DC 10 con throw else target paralyzed for min but repeat throw at end of each turn"}),
