 ...
 * @author Ryan
 */
public class GiantElk extends Minions{
    ...
    public GiantElk(int wizlv, int proficiency, int acBoost)
    {
    ...
    public void setUp(int wizlv, int proficiency, int acBoost)
    {
        ...
        {                                   //the different Attacks in Attack[] are the different combos that the creature could attack with on their turn, while diff attacks in Attack() will all be done consecutively
            new Attacks(
                ...
                new Dice[]{
                    new Dice(6,2,4)},
                new String[]{name + " Ram, Range 10ft, Charge mechanic"}),
            new Attacks(
                new Dice[]{
                    new Dice(20,1,6)},
                new Dice[]{
                    new Dice(8,4,4)},
                new String[]{name + " Hooves, Range 5ft"}),
