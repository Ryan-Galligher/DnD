 ...
 * @author ryan
 */
public class LoveForLostGhost extends Minions 
{
        
    public LoveForLostGhost()
    {
        super.hp=2;
        super.ac=2;
        super.name="LFLGhost";
    ...
    public LoveForLostGhost(int wizlv, int proficiency, int acBoost)
    {
    ...
    public void setUp(int wizlv, int proficiency, int acBoost)
    {
        ...
        {                                   //the different Attacks in Attack[] are the different combos that the creature could attack with on their turn, while diff attacks in Attack() will all be done consecutively
            new Attacks(
                ...
                new Dice[]{
                    new Dice(8,1,0)},
                new String[]{name + " Chill Touch, Range 120 feet"}),
            new Attacks(
                new Dice[]{
                    new Dice(20,1,4)},
                new Dice[]{
                    new Dice(6,1,2)},
                new String[]{name + " Posession of crossbow, range 120ft"}),
